...
public class TicketBooker {
	...
	//book ticket
	public void bookTicket(Passenger p, int berthNumber,String allotedBerth)
	{
		//assign the seat number and type of berth(L,U,M)
		p.number = berthNumber;
	...
	public void cancelTicket(int passengerId)
	{
		...
		passengers.remove(Integer.valueOf(passengerId));//Integer.valueOf(passengerId)
